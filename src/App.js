    ...
    return (
      <div className="App">
        ...
        <p className="App-intro">
          To get started, edit <code>{this.props.valueText}</code> and save to reload in {this.props.valueNumber}.
        </p>
...
const mapDispatchToProps = (dispatch) => {
  return {
    changeText: () => { dispatch(changeText("please")) },
    asyncNumber: () => { dispatch(getAsyncNumber()) }
  }
};
