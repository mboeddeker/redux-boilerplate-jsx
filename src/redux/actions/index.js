...
export const changeText = (text: string): IActionType => ({
  type: ACTION.CHANGE_TEXT,
  payload: text
});

export const addNumberAsync = (num: number): IActionType => ({
  type: ACTION.ASYNC_NUMBER,
  payload: num
});

export const clearNumberAsync = (): IActionType => ({
  type: ACTION.CLEAR_NUMBER,
  payload: 0
});
